...
interface PizzasDatabaseHelper {
    ...
    void insertPizza(SQLiteDatabase db, String name, String description, int resourceId);
    ...
    class Base extends SQLiteOpenHelper implements PizzasDatabaseHelper {
        ...
        @Override
        public void insertPizza(SQLiteDatabase db, String name, String description, int resourceId) {
            ContentValues pizzaValues = new ContentValues();
            pizzaValues.put(NAME_KEY, name);
            pizzaValues.put(DESCRIPTION_KEY, description);
